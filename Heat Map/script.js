...
function saveData(data) {
  ...
  svg
    ...
    .attr(
      "transform",
      "translate(" + -7 * 12 + "," + height / 2 + ")" + "rotate(-90)"
    )
    .attr("fill", "black");
  ...
  svg
    ...
    .text("Years")
    .style("text-anchor", "middle")
    .attr("transform", "translate(" + width / 2 + "," + 3 * 12 + ")")
    .attr("fill", "black");
  ...
  var legend = svg
    ...
    .attr(
      ...
      "translate(" +
        padding +
        "," +
        (padding + height + padding - 2 * legendHeight) +
        ")"
    );
  ...
  // console.log(legendThreshold(data.baseTemperature + data..variance));
  svg
    .append("g")
    .classed("map", true)
    .attr("transform", "translate(" + padding + "," + padding + ")")
